    ...
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        MimeBodyPart res = gen.generateEncapsulated(msg, "SC");
        ...
        throws Exception
    {
        ...
        verifySigners(s.getCertificatesAndCRLs("Collection", "SC"), s.getSignerInfos());
        ...
        throws Exception
    {
        ...
        SMIMESigned newS =  new SMIMESigned(gen.generate(msg, "SC"));

        verifyMessageBytes(msg, newS.getContent());

        verifySigners(newS.getCertificatesAndCRLs("Collection", "SC"), newS.getSignerInfos());
    }
        ...
        throws Exception
    {
        ...
        MimeMultipart     smm = gen.generate(msg, "SC");
        SMIMESignedParser s = new SMIMESignedParser(smm);
        ...
        throws Exception
    {
        ...
        X509Store store = X509Store.getInstance("AttributeCertificate/Collection",
                                    new X509CollectionStoreParameters(Collections.singleton(attrCert)), "SC");

        gen.addAttributeCertificates(store);

        SMIMESigned s = new SMIMESigned(gen.generateEncapsulated(msg, "SC"));

        verifyMessageBytes(msg, s.getContent());

        verifySigners(s.getCertificatesAndCRLs("Collection", "SC"), s.getSignerInfos());

        X509Store attrCerts = s.getAttributeCertificates("Collection", "SC");
        ...
        throws Exception
    {
        ...
        return gen.generateEncapsulated(msg, "SC");
    }
        ...
        throws Exception
    {
        ...
        MimeBodyPart smm = gen.generateCertificateManagement("SC");
        ...
        throws Exception
    {
        ...
        MimeMultipart mm = gen.generate(m, "SC");
...
//
//        verifySigners(sp.getCertificatesAndCRLs("Collection", "SC"), sp.getSignerInfos());
//    }
