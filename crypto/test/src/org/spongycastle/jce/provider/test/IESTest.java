    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        c1 = Cipher.getInstance("IES", BouncyCastleProvider.PROVIDER_NAME);
        c2 = Cipher.getInstance("IES", BouncyCastleProvider.PROVIDER_NAME);
        
        g = KeyPairGenerator.getInstance("DH", BouncyCastleProvider.PROVIDER_NAME);
