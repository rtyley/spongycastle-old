    ...
    extends SimpleTest
{
    ...
    public void performTest() throws Exception
    {
        ...
        //
        s = Signature.getInstance("SHA512withRSAandMGF1", BouncyCastleProvider.PROVIDER_NAME);
            ...
            PrivateKey privKey, PublicKey pubKey, SecureRandom random) throws Exception
    {
        ...
        Signature rawSig = Signature.getInstance("RAWRSASSA-PSS", BouncyCastleProvider.PROVIDER_NAME);
