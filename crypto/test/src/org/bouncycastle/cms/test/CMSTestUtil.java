...
public class CMSTestUtil
{
    ...
    static
    {
        try
        {
            ...
            gostKpg  = KeyPairGenerator.getInstance("GOST3410", BouncyCastleProvider.PROVIDER_NAME);
            ...
            dsaKpg = KeyPairGenerator.getInstance("DSA", BouncyCastleProvider.PROVIDER_NAME);
            ...
            ecGostKpg = KeyPairGenerator.getInstance("ECGOST3410", BouncyCastleProvider.PROVIDER_NAME);
            ecGostKpg.initialize(ECGOST3410NamedCurveTable.getParameterSpec("GostR3410-2001-CryptoPro-A"), new SecureRandom());

            ecDsaKpg = KeyPairGenerator.getInstance("ECDSA", BouncyCastleProvider.PROVIDER_NAME);
            ecDsaKpg.initialize(239, new SecureRandom());

            aes192kg = KeyGenerator.getInstance("AES", BouncyCastleProvider.PROVIDER_NAME);
            ...
            aesKg = KeyGenerator.getInstance("AES", BouncyCastleProvider.PROVIDER_NAME);

            seedKg = KeyGenerator.getInstance("SEED", BouncyCastleProvider.PROVIDER_NAME);

            camelliaKg = KeyGenerator.getInstance("Camellia", BouncyCastleProvider.PROVIDER_NAME);
    ...
    public static X509AttributeCertificate getAttributeCertificate()
        throws Exception
    {
        X509StreamParser parser = X509StreamParser.getInstance("AttributeCertificate", BouncyCastleProvider.PROVIDER_NAME);
        ...
        throws Exception
    {
        ...
        return crlGen.generate(pair.getPrivate(), BouncyCastleProvider.PROVIDER_NAME);
    }
