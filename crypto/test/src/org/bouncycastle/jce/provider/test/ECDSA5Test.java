    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        PublicKey pubKey = ECKeyUtil.publicToExplicitParameters(pair.getPublic(), BouncyCastleProvider.PROVIDER_NAME);
        ...
        PrivateKey privKey = ECKeyUtil.privateToExplicitParameters(pair.getPrivate(), BouncyCastleProvider.PROVIDER_NAME);
