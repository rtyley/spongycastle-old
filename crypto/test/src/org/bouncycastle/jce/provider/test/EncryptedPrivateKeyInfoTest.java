    ...
    implements Test
{
    ...
    public TestResult perform()
    {
        try
        {
            KeyPairGenerator fact = KeyPairGenerator.getInstance("RSA", BouncyCastleProvider.PROVIDER_NAME);
            ...
            AlgorithmParameters params = AlgorithmParameters.getInstance(alg, BouncyCastleProvider.PROVIDER_NAME);
            ...
            SecretKeyFactory    keyFact = SecretKeyFactory.getInstance(alg, BouncyCastleProvider.PROVIDER_NAME);
            ...
            cipher = Cipher.getInstance(pInfo.getAlgName(), BouncyCastleProvider.PROVIDER_NAME);
            ...
            keyFact = SecretKeyFactory.getInstance(alg, BouncyCastleProvider.PROVIDER_NAME);
