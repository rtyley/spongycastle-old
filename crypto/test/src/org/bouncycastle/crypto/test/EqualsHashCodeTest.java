        ...
        extends SimpleTest
{
    ...
    private void dhTest()
    {
        ...
        DHParameters                pr2 = new DHParameters(pr1.getP(), pr1.getG(), pr1.getQ(), pr1.getJ(), pr1.getValidationParameters());
        DHParameters                pr3 = new DHParameters(pr1.getG(), pr1.getP(), pr1.getQ(), pr1.getJ(), pr1.getValidationParameters());

        doTest(pr1, pr2, pr3);

        pr3 = new DHParameters(pr1.getG(), pr1.getP(), null, pr1.getJ(), pr1.getValidationParameters());
