    ...
    extends SimpleTest
{
    ...
    private BigInteger yPgpSamp = new BigInteger("", 16);
    private BigInteger xPgpSamp = new BigInteger("", 16);
    private BigInteger gPgpSamp = new BigInteger("", 16);
    private BigInteger pPgpSamp = new BigInteger("", 16);
    private int        lPgpSamp = 0;
    ...
    private void testPgpSampEnc()
    {
        ElGamalParameters               dhParams = new ElGamalParameters(pPgpSamp, gPgpSamp, lPgpSamp);
        ElGamalPublicKeyParameters      pu = new ElGamalPublicKeyParameters(yPgpSamp, dhParams);
        ElGamalPrivateKeyParameters     pv = new ElGamalPrivateKeyParameters(xPgpSamp, dhParams);
        ...
        try
        {
            ...
            e.processBlock(bytes, 0, bytes.length - 2);
        }
        catch (DataLengthException ex)
        {
            fail("in range block failed");
