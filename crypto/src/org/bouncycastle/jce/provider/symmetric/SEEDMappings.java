    ...
    extends HashMap
{
    public SEEDMappings()
    {
        ...
        put("Cipher.SEEDWRAP", "org.bouncycastle.jce.provider.WrapCipherSpi$Wrap");
        ...
        put("KeyGenerator." + KISAObjectIdentifiers.id_npki_app_cmsSeed_wrap, "org.bouncycastle.jce.provider.symmetric.SEED$KeyGen128");
    }
}
