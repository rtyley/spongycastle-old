        ...
        if (idp != null && idp.getDistributionPoint() != null)
        {
            ...
            try
            {
                bc = BasicConstraints.getInstance(CertPathValidatorUtilities
                    .getExtensionValue((X509Extension)cert, BASIC_CONSTRAINTS));
            }
            catch (Exception e)
            {
                throw new AnnotatedException(
                    ...
                    if (!idp_found)
                    {
                        ...
                        while (nodes_i.hasNext())
                        {
                            PKIXPolicyNode node = (PKIXPolicyNode) nodes_i
                                .next();
                            if (RFC3280CertPathUtilities.ANY_POLICY.equals(node
                                .getValidPolicy()))
                            {
                                Set pq = null;
                                ...
                                while (e.hasMoreElements())
                                {
                                    ...
                                    if (RFC3280CertPathUtilities.ANY_POLICY
        ...
        throws CertPathValidatorException
    {
        ...
        if (certPolicies != null && validPolicyTree != null)
        {
            ...
            if (acceptablePolicies == null
                || acceptablePolicies
                    .contains(RFC3280CertPathUtilities.ANY_POLICY))
            {
                ...
                || ((i < n) && CertPathValidatorUtilities.isSelfIssued(cert)))
            {
                ...
                while (e.hasMoreElements())
                {
                    ...
                    if (RFC3280CertPathUtilities.ANY_POLICY.equals(pInfo
        ...
        ReasonsMask reasonMask, List certPathCerts) throws AnnotatedException
    {
            ...
            && !reasonMask.isAllReasons())
        {
            try
            {
                ...
                // (f)
                Set keys = RFC3280CertPathUtilities.processCRLF(crl, cert,
                ...
                // (i)
                RFC3280CertPathUtilities.processCRLI(validDate, deltaCRL, cert.getSerialNumber(),
                    certStatus, paramsPKIX);

                // (j)
                RFC3280CertPathUtilities.processCRLJ(validDate, crl, cert.getSerialNumber(),
                    certStatus);
        ...
        else
        {
            ...
            for (int j = 0; j < policyNodes.length; j++)
            {
                ...
                for (int k = 0; k < _nodeDepth.size(); k++)
                {
                    ...
                    if (RFC3280CertPathUtilities.ANY_POLICY.equals(_node
                        .getValidPolicy()))
                    {
                        Iterator _iter = _node.getChildren();
                        while (_iter.hasNext())
