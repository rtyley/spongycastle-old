...
{
    private ContentSignerHelper helper = new DefaultContentSignerHelper();
    ...
    {
        this.helper = new ProviderContentSignerHelper(provider);
    ...
    {
        this.helper = new NamedContentSignerHelper(providerName);
        ...
        throws OperatorCreationException
    {
        try
        {
            ...
            return new ContentSigner()
            {
                ...
                public OutputStream getSigningOutputStream()
                {
                    return stream;
                }
