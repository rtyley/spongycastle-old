...
public class TextBundle extends LocalizedMessage 
{
     ...
     * @throws NullPointerException if <code>resource</code> or <code>id</code> is <code>null</code>
     */
    public TextBundle(String resource, String id, ClassLoader loader) throws NullPointerException 
    {
     ...
     * @throws NullPointerException if <code>resource</code> or <code>id</code> is <code>null</code>
     */
    public TextBundle(String resource, String id, ClassLoader loader, Object[] arguments) throws NullPointerException 
    {
