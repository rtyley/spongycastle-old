    ...
    implements Cloneable
{
     ...
     */
    public static final NTRUEncryptionParameters EES1087EP2 = new NTRUEncryptionParameters(1087, 2048, 120, 120, 256, 13, 25, 14, true, new byte[]{0, 6, 3}, true, false, new SHA512Digest());
     ...
     */
    public static final NTRUEncryptionParameters EES1171EP1 = new NTRUEncryptionParameters(1171, 2048, 106, 106, 256, 13, 20, 15, true, new byte[]{0, 6, 4}, true, false, new SHA512Digest());
     ...
     */
    public static final NTRUEncryptionParameters EES1499EP1 = new NTRUEncryptionParameters(1499, 2048, 79, 79, 256, 13, 17, 19, true, new byte[]{0, 6, 5}, true, false, new SHA512Digest());

    /**
     * A parameter set that gives 128 bits of security and uses simple ternary polynomials.
     */
    public static final NTRUEncryptionParameters APR2011_439 = new NTRUEncryptionParameters(439, 2048, 146, 130, 128, 9, 32, 9, true, new byte[]{0, 7, 101}, true, false, new SHA256Digest());
     ...
     */
    public static final NTRUEncryptionParameters APR2011_439_FAST = new NTRUEncryptionParameters(439, 2048, 9, 8, 5, 130, 128, 9, 32, 9, true, new byte[]{0, 7, 101}, true, true, new SHA256Digest());

    /**
     * A parameter set that gives 256 bits of security and uses simple ternary polynomials.
     */
    public static final NTRUEncryptionParameters APR2011_743 = new NTRUEncryptionParameters(743, 2048, 248, 220, 256, 10, 27, 14, true, new byte[]{0, 7, 105}, false, false, new SHA512Digest());
     ...
     */
    public static final NTRUEncryptionParameters APR2011_743_FAST = new NTRUEncryptionParameters(743, 2048, 11, 11, 15, 220, 256, 10, 27, 14, true, new byte[]{0, 7, 105}, false, true, new SHA512Digest());
