...
public interface X9ObjectIdentifiers
{
    ...
    static final DERObjectIdentifier prime_field = new DERObjectIdentifier(id_fieldType + ".1");

    static final DERObjectIdentifier characteristic_two_field = new DERObjectIdentifier(
        id_fieldType + ".2");

    static final DERObjectIdentifier gnBasis = new DERObjectIdentifier(id_fieldType + ".2.3.1");

    static final DERObjectIdentifier tpBasis = new DERObjectIdentifier(id_fieldType + ".2.3.2");

    static final DERObjectIdentifier ppBasis = new DERObjectIdentifier(id_fieldType + ".2.3.3");
    ...
    static final DERObjectIdentifier id_ecPublicKey = new DERObjectIdentifier(id_publicKeyType
        + ".1");

    static final DERObjectIdentifier ecdsa_with_SHA2 = new DERObjectIdentifier(id_ecSigType + ".3");

    static final DERObjectIdentifier ecdsa_with_SHA224 = new DERObjectIdentifier(ecdsa_with_SHA2
        + ".1");

    static final DERObjectIdentifier ecdsa_with_SHA256 = new DERObjectIdentifier(ecdsa_with_SHA2
        + ".2");

    static final DERObjectIdentifier ecdsa_with_SHA384 = new DERObjectIdentifier(ecdsa_with_SHA2
        + ".3");

    static final DERObjectIdentifier ecdsa_with_SHA512 = new DERObjectIdentifier(ecdsa_with_SHA2
        + ".4");
     ...
     * (10040) x9cm(4) 3 }
     */
    public static final DERObjectIdentifier id_dsa_with_sha1 = new DERObjectIdentifier(
        "1.2.840.10040.4.3");

    /**
     * X9.63
     */
    public static final DERObjectIdentifier x9_63_scheme = new DERObjectIdentifier(
        "1.3.133.16.840.63.0");
    public static final DERObjectIdentifier dhSinglePass_stdDH_sha1kdf_scheme = new DERObjectIdentifier(
        x9_63_scheme + ".2");
    public static final DERObjectIdentifier dhSinglePass_cofactorDH_sha1kdf_scheme = new DERObjectIdentifier(
        x9_63_scheme + ".3");
    public static final DERObjectIdentifier mqvSinglePass_sha1kdf_scheme = new DERObjectIdentifier(
        x9_63_scheme + ".16");
    ...
    static final String ansi_X9_42 = "1.2.840.10046";
    ...
    public static final DERObjectIdentifier dhOneFlow = new DERObjectIdentifier(x9_42_schemes
        + ".3");
    public static final DERObjectIdentifier dhHybrid1 = new DERObjectIdentifier(x9_42_schemes
        + ".4");
    public static final DERObjectIdentifier dhHybrid2 = new DERObjectIdentifier(x9_42_schemes
        + ".5");
    public static final DERObjectIdentifier dhHybridOneFlow = new DERObjectIdentifier(x9_42_schemes
        + ".6");
