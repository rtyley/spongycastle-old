...
//        _encAlg = encAlg;
        ...
        throws CMSException
    {
        try
        {
            ...
            KeyFactory fact = KeyFactory.getInstance(_keyEncAlg.getObjectId().getId(), prov.getName());
            KeyAgreement agreement = KeyAgreement.getInstance(_keyEncAlg.getObjectId().getId(), prov.getName());
