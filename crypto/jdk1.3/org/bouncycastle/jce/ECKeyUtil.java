...
public class ECKeyUtil
{
     ...
     */
    public static PublicKey publicToExplicitParameters(PublicKey key, String provider)
     ...
     * @throws NoSuchProviderException
     */
    public static PrivateKey privateToExplicitParameters(PrivateKey key, String provider)
        throws IllegalArgumentException, NoSuchAlgorithmException, NoSuchProviderException
    {
        try
        {
