...
public class PKIXCertPathValidatorSpi extends CertPathValidatorSpi
{
     ...
     */
    private ASN1Object getExtensionValue(
        ...
        for (index = certs.size() - 1; index >= 0 ; index--)
        {
            try
            {
                ...
                if (i != n)
                {
                    ...
                    //
                    ASN1Object   pm = getExtensionValue(cert, POLICY_MAPPINGS);
                    if (pm != null)
                    {
        ...
        throws AnnotatedException 
    {
        ...
        while (crl_iter.hasNext())
        {
            ...
            if (cert.getNotAfter().after(crl.getThisUpdate()))
            {
                ...
                //
                ASN1Object idp = getExtensionValue(crl, ISSUING_DISTRIBUTION_POINT);
                ASN1Object dci = getExtensionValue(crl, DELTA_CRL_INDICATOR);
                ...
                if (dci != null)
                {
                    ...
                    while (it.hasNext())
                    {
                        ...
                        ASN1Object baseIdp = getExtensionValue(base, ISSUING_DISTRIBUTION_POINT);
