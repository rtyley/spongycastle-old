    ...
    **/
    ...
    public String toString()
    {
        ...
        try {
            ...
            sb.append("  Subject Key Identifier: " + ASN1Dump.dumpAsString(derObject) + "\n");
            }
            if ( authorityKeyID != null )
            {
            ...
            DERInputStream derInStream = new DERInputStream(inStream);
            DERObject derObject = derInStream.readObject();
            sb.append("  Authority Key Identifier: " + ASN1Dump.dumpAsString(derObject) + "\n");
            }
        ...
        if (subjectKeyAlgID != null)
            sb.append("  Subject Public Key AlgID: " + subjectKeyAlgID.toString() + "\n");
        ...
        if ( subjectAltNamesByte != null )
        {
            ...
            while ( iter.hasNext() )
            {
                ...
                DERInputStream derInStream = new DERInputStream(inStream);
                DERObject derObject = derInStream.readObject();
                sb.append("  Type: " + obj.get(0) + " Data: " + ASN1Dump.dumpAsString(derObject) + "\n");
            }
            } catch ( IOException ex ) {
            sb.append( ex.getMessage() + "\n" );
            }
