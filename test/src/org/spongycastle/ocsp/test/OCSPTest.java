...
import org.spongycastle.ocsp.BasicOCSPRespGenerator;
...
import org.spongycastle.ocsp.OCSPRespGenerator;
import org.spongycastle.ocsp.Req;
    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        X509Certificate[] certs = req.getCerts(BouncyCastleProvider.PROVIDER_NAME);
        ...
        req = gen.generate("SHA1withECDSA", signKP.getPrivate(), chain, BouncyCastleProvider.PROVIDER_NAME);
        ...
        if (!req.verify(signKP.getPublic(), BouncyCastleProvider.PROVIDER_NAME))
        {
        ...
        certs = req.getCerts(BouncyCastleProvider.PROVIDER_NAME);
        ...
        if (!newReq.verify(signKP.getPublic(), BouncyCastleProvider.PROVIDER_NAME))
        {
        ...
        BasicOCSPResp resp = respGen.generate("SHA1withECDSA", signKP.getPrivate(), chain, new Date(), BouncyCastleProvider.PROVIDER_NAME);
    }
        ...
        throws Exception
    {
        ...
        req = gen.generate("SHA1withRSA", signKP.getPrivate(), chain, BouncyCastleProvider.PROVIDER_NAME);
        ...
        BasicOCSPResp resp = respGen.generate("SHA1withRSA", signKP.getPrivate(), chain, new Date(), BouncyCastleProvider.PROVIDER_NAME);
        ...
        throws Exception
    {
        ...
        X509Certificate cert = ocspRequest.getCerts(BouncyCastleProvider.PROVIDER_NAME)[0];
        if (!ocspRequest.verify(cert.getPublicKey(), BouncyCastleProvider.PROVIDER_NAME))
        {
        ...
        throws Exception
    {
        ...
        chain = brep.getCerts(BouncyCastleProvider.PROVIDER_NAME);

        if (!brep.verify(chain[0].getPublicKey(), BouncyCastleProvider.PROVIDER_NAME))
        {
