    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        InputStream clear = pbe.getDataStream(pass, BouncyCastleProvider.PROVIDER_NAME);
        ...
        throws Exception
    {
        ...
        PGPEncryptedDataGenerator    cPk = new PGPEncryptedDataGenerator(PGPEncryptedData.CAST5, new SecureRandom(), BouncyCastleProvider.PROVIDER_NAME);
        ...
        cPk = new PGPEncryptedDataGenerator(PGPEncryptedData.CAST5, new SecureRandom(), BouncyCastleProvider.PROVIDER_NAME);
        ...
        cbOut = new ByteArrayOutputStream();
        cPk = new PGPEncryptedDataGenerator(PGPEncryptedData.CAST5, rand, BouncyCastleProvider.PROVIDER_NAME);
        ...
        //
        cbOut = new ByteArrayOutputStream();
        cPk = new PGPEncryptedDataGenerator(PGPEncryptedData.CAST5, true, rand, BouncyCastleProvider.PROVIDER_NAME);
        ...
        InputStream clear = pbe.getDataStream("password".toCharArray(), BouncyCastleProvider.PROVIDER_NAME);
