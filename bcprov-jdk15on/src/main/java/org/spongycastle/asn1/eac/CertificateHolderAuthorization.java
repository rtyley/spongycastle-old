    ...
    extends ASN1Object
{
    ...
    static
    {
        RightsDecodeMap.put(new Integer(RADG4), "RADG4");
        RightsDecodeMap.put(new Integer(RADG3), "RADG3");

        AuthorizationRole.put(new Integer(CVCA), "CVCA");
        AuthorizationRole.put(new Integer(DV_DOMESTIC), "DV_DOMESTIC");
        AuthorizationRole.put(new Integer(DV_FOREIGN), "DV_FOREIGN");
        AuthorizationRole.put(new Integer(IS), "IS");
